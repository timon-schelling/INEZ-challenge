...
class MapQueryExceptionValueCantBeCastedTo(castFrom: String, castTo: String) :
...
class MapQueryExceptionOutOfListRangeException :
        MapQueryException("index/key has to be lager/equal to 0 and smaller/equal size (of the list)")
